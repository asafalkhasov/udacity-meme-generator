<template>
    <div class="create-code" style="margin-top:10rem;">
        <b-card title="Add new Meme" v-if="createCodeForm">
...
export default class CreateCode extends Vue {
    ...
    async createCode(event: any) {
        ...
        this.$router.push({ name: "my-memes", query: {"uploaded": "true"} });
    }
